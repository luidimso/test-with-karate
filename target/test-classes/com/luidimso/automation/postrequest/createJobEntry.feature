Feature: To create a job entry in the application
		...
		Scenario: To create a job entry in JSON format
			...
			And request {"jobId": 619, "jobTitle": "Web Developer", "jobDescription": "To develop web applications","experience": ["Developer"],"project": [{"projectName": "Social Media","technology": ["JavaScript"]}]}
