Feature: To create a job entry in the application
		...
		Background: Setup the Base path
			...
			* def getJobId = function(value) {return 619;}
			* def body = {"jobId": "#(getJobId())", "jobTitle": "Web Developer", "jobDescription": "To develop web applications","experience": ["Developer"],"project": [{"projectName": "Social Media","technology": ["JavaScript"]}]}
